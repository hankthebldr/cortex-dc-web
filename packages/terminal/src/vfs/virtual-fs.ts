/**
 * Virtual File System (VFS) - Migrated from henryreed.ai
 *
 * Provides a Unix-like virtual file system for terminal operations
 * Supports standard file/directory operations without touching real filesystem
 */
          ...
          guest: {
            ...
            children: {
              'readme.txt': {
                type: 'file',
                name: 'readme.txt',
                content: `Welcome to Cortex DC Terminal!
