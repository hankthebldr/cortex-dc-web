...
/**
 * Cortex Button Component
 * Migrated from henryreed.ai/hosting/components/CortexButton.tsx
 *
...
export const CortexButton = React.forwardRef<HTMLButtonElement, CortexButtonProps>(({
  variant = 'primary',
  size = 'md',
  disabled = false,
  loading = false,
  ...
  const handleClick = async (event?: React.MouseEvent) => {
    ...
    if (trackActivity) {
      try {
        ...
        const userActivityService = (dbModule as any).userActivityService;
        if (userActivityService && typeof userActivityService.trackActivity === 'function') {
...
CortexButton.displayName = 'CortexButton';
