 ...
 * Document metadata editor with basic, advanced, and custom field support
 * Migrated from henryreed.ai/hosting/components/MetadataEditor.tsx
 */
  ...
  return (
    <div className="bg-gray-900 rounded-lg border border-gray-800 p-6 space-y-6">
      ...
      <div className="flex space-x-2 border-b border-gray-700">
        {(['basic', 'advanced', 'custom'] as const).map(tab => (
          <button
            key={tab}
