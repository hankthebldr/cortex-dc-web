 ...
 * Migrated from henryreed.ai/hosting/components/TerminalWindow.tsx
 *
 * Features:
 * - Interactive terminal-style interface
 * - Command input with prompt
 * - Auto-scrolling output
 * - Demo mode for automated command playback
...
export interface TerminalWindowProps {
  ...
  title?: string;
  /** Pre-defined commands for demo mode */
  commands?: string[];
