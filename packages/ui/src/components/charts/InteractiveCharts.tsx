...
/**
 * Interactive Charts Component Library
 * Migrated from henryreed.ai/hosting/components/InteractiveCharts.tsx
 *
 * Lightweight charting components built with React and SVG:
 * - BarChart: Horizontal bar chart with hover effects
 * - PieChart: Pie chart with CSS conic gradients
 * - LineChart: SVG line chart with time series data
 * - KPICard: Key performance indicator display cards
 * - DashboardGrid: Responsive grid layout for dashboards
 */
