...
/**
 * Clean Terminal Popout Component
 * Draggable, resizable terminal window with minimize/maximize controls
 * Migrated from henryreed.ai/hosting/components/ui/CleanTerminalPopout.tsx
 */

import React, { useState, useRef, useEffect } from 'react';

export interface CleanTerminalPopoutProps {
  isOpen: boolean;
  onClose: () => void;
  onMinimize?: () => void;
  title?: string;
  ...
  return (
    <>
      ...
      <div
        ...
        className="bg-gray-900 border border-gray-700 rounded-lg shadow-2xl overflow-hidden flex flex-col transition-all duration-300 ease-out transform"
      >
        {/* Header */}
        <div
          ref={headerRef}
