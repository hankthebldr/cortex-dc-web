 ...
 * Executes commands in cloud environments with RBAC filtering and WebSocket communication
 *
 * Migrated from henryreed.ai/hosting/lib/cloud-command-executor.ts
 */

import { RBACMiddleware, type RBACContext } from '@cortex/db';

export interface CloudEnvironmentConfig {
  enabled: boolean;
  provider: 'aws' | 'gcp' | 'azure';
  connectionType: 'ssh' | 'cloud-shell' | 'api';
  endpoints: {
